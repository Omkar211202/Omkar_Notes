...
- Process design and management - product service dev - supply chain management.
- Design, management, and improvement of the systems that create and deliver products and services to the customer.
- manage: smooth execution
- improve: continuous improvement to enhance productivity, quality and customer satisfaction.
...
- customer participation, simultaneous , perishable, intangibility and heterogeneity. (CSPIH)
...
- proposed Zero defects - do it right the first time. (Philip B Crosby)
...
> 
> 8 dim: Performance, Features, Reliability, Conformance, Durability, Serviceability, Aesthetics, Safety

- organization wide effort to develop skills, tools, techniques and mindset required to establish a quality assurance system that is responsive to emerging market needs.
...
Control costs: prevention, appraisal, failure costs.
...
- productive system, use of system.
...
- staffing plan.
- meet customer demand, resource utilization, cost management, work force planning, inventory management, production and operations efficiency.
